...
public class HtmlEncoder {
    ...
    /**
     * Do "smart" encodging on a string. This means that valid HTML entities and
     * tags, Helma macros and HTML comments are passed through unescaped, while
     ...
     * @param paragraphs if true use p tags for paragraphs, otherwise just use
     * br's
     * @param allowedTags a set containing the names of allowed tags as strings.
